...
tweak_data.screen_colors.cn_locked = Color(0.8,1,1,1)
tweak_data.screen_colors.cn_locked_dark = Color(0,0,0,0)
tweak_data.screen_colors.cn_dlc_color_dark = deep_clone(tweak_data.screen_colors.dlc_color):with_alpha(0.8)
